...
namespace BookingService.API.Test
{
    ...
    public class GetMovieCruiserTest
    {
        private GetBookinggRequest getMovieCruiserRequest;

        private GetBookings getMovieCruiser;

        [Fact]
        public async Task HandleWithValidGetMovieRequestCallGetMovieListAsExpectedResult()
        {
            // Arrange
            ...
            var result = await getMovieCruiser.Handle(getMovieCruiserRequest, cancellationToken);
        ...
        [Fact]
        public async Task HandleWithValidGetMovieRequestCallRetrunsNotFoundResult()
        {
            // Arrange
        ...
        [Fact]
        public async Task HandleWithNullGetMovieRequestCallRetrunAsExpected()
        {
            // Arrange
            var httpClientStatus = HttpStatusCode.OK;
            InitializeFixture(httpClientStatus);
            getMovieCruiserRequest = null;
